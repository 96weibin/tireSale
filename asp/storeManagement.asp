...
<%
    ...
    If Status = 1 Then
        ...
        Do While not (InvoiceRS.Bof or InvoiceRS.Eof)
            ...
            Cmd.CommandText = "SELECT Logistics, Client, Pral, Size, Quantity, Status, Price FROM P_TyreSaleClass Where(Logistics ='"&InvoiceRS("Invoice")&"')"
