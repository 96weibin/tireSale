  ...
  return function a(b, c, d) {
    ...
    56: [function (a, b) {
      var c = a("./node"),
        ...
        var j;
        if (this.name = a, this.value = b, c) for (Array.isArray(c) ? this.rules = c : (this.rules = [c], this.rules[0].selectors = new d([], null, null, this.index, _f).createEmptySelectors()), j = 0; this.rules.length > j; j++) {
      ...
      f.prototype = new c(), f.prototype.type = "Directive", f.prototype.accept = function (a) {
        ...
        var a, b;
        if (this.isReferenced = !0, this.rules) for (b = this.rules, a = 0; b.length > a; a++) {
    ...
    67: [function (a, b) {
      ...
      i.prototype = new e(), i.prototype.type = "MixinDefinition", i.prototype.evalFirst = !0, i.prototype.accept = function (a) {
        ...
        var i,
            ...
            s = 0;
        if (b.frames && b.frames[0] && b.frames[0].functionRegistry && (q.functionRegistry = b.frames[0].functionRegistry.inherit()), b = new h.Eval(b, [q].concat(b.frames)), c) for (c = c.slice(0), s = c.length, k = 0; s > k; k++) {
          if (j = c[k], n = j && j.name) {
    ...
    75: [function (a, b) {
      ...
      l.prototype = new c(), l.prototype.type = "Ruleset", l.prototype.isRuleset = !0, l.prototype.isRulesetLike = !0, l.prototype.accept = function (a) {
        ...
        var a, b, c, d;
        if (this.paths) for (a = 0; this.paths.length > a; a++) {
        ...
        var m, n, o;
        if (n = [], o = i(n, b, c), !o) if (b.length > 0) for (n = [], m = 0; b.length > m; m++) {
          n.push(b[m].concat(c));
        } else n = [[c]];
